...
const ResCard = (props) => {
  ...
  return (
    <div
      data-testid="ResCard"
      className="md:w-[220px] w-[170] flex-wrap md:m-[15px] m-2 p-2 border-b-1 md:shadow-xl shadow-lg dark:shadow-gray-500 rounded-lg font-poppins  transition-all duration-300 delay-100 ease-in-out hover:cursor-pointer bg-cyan-100 dark:bg-gray-800 hover:scale-105"
    >
      <img
      ...
      <div className="flex justify-between">
        ...
        <button
          className="w-1/5 md:text-xl transition-all ease-in-out delay-100 duration-300 hover:scale-80 hover:cursor-pointer"
          onClick={(e) => {
            e.preventDefault();
            e.stopPropagation();
  ...
  return (props) => {
    ...
    return (
      <div className="relative">
        <label className="z-10 p-2 bg-cyan-300 dark:bg-gray-600 rounded-lg md:text-sm text-xs font-semibold font-poppins  absolute border-1 ">
          Promoted👍
        </label>
        <ResCard {...props} />
      </div>
