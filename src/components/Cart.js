  ...
  return cartItems.length === 0 ? (
    ...
    <div className="md:pt-[160px] pt-[100px] md:w-8/12 m-auto font-poppins ">
      <div className="flex my-5 justify-between">
        ...
        <button
          className="p-2 bg-cyan-300 dark:bg-gray-800 rounded-lg text-sm font-semibold font-poppins border-black dark:border-white border-b shadow-2xl hover:cursor-pointer"
          onClick={() => {
            //clear list
            dispatch(clearCart());
          }}
      ...
      <div className="my-2.5 p-2 shadow-2xl dark:shadow-gray-400 border-black dark:border-white border-b rounded-lg bg-cyan-300 dark:bg-gray-800 md:text-md text-sm">
        {cartItems.map((cartItem) => (
          <div
            data-testid="cartItem"
            key={cartItem.card.info.id}
            className="p-2 mx-2 my-4 border-black dark:border-white border-b shadow-lg dark:shadow-gray-400 rounded-lg flex justify-between bg-cyan-200 dark:bg-cyan-800"
          >
            ...
            <div className="md:w-2/12 w-1/4 flex justify-center">
              ...
              <div className="md:text-md text-xs md:w-20 w-14 md:h-8 h-6 md:-mt-0 -mt-[6px] bg-cyan-400 dark:bg-gray-800 rounded-lg font-semibold z-10 absolute flex justify-between">
                <button
                  className="border-black border dark:border-white w-1/3 bg-cyan-300 dark:bg-cyan-800 rounded-lg transition-all ease-in-out duration-300 hover:scale-90 hover:cursor-pointer"
                  onClick={() => {
                    //dispatch an action
      ...
      <div className="mt-8 shadow-2xl dark:shadow-gray-400 border-black dark:border-white border-b rounded-lg bg-cyan-300 dark:bg-gray-800  font-bold md:flex ">
        <div className="md:w-1/2 h-fit p-2 m-2 border-black dark:border-white border-b shadow-lg rounded-lg bg-cyan-200 dark:bg-cyan-900">
        ...
        <div className="md:w-1/2 h-fit p-2 m-2 border-black dark:border-white border-b shadow-lg rounded-lg bg-cyan-200 dark:bg-cyan-900">
          ...
          <button className="flex justify-center border-black border dark:border-white w-full text-center rounded-lg bg-cyan-500 dark:bg-gray-800 p-2 transition-all ease-in-out delay-50 duration-200 hover:bg-cyan-600 hover:dark:bg-cyan-900 hover:cursor-pointer hover:text-white ">
